...
Content synced from **Ban_Tran_CV_2026** (`raw/CVs/Ban_Tran_CV_2026.pdf`, August 2026).
...
> Referee names and contact details are **deliberately not published** on the site. Search committees
> receive them through the application portal instead. The `Contact` section points enquirers to email.
